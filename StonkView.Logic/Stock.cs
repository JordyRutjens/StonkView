...
namespace StonkView.Logic
{
    public class Stock
    {
        public static StonkView.Models.StockModel.StockArray[] stocks;
        public static void LoadStocks()
        {
            using (var webClient = new WebClient())
            {
                ...
                var _stocks = StockModel.StockArray.FromJson(jsonString);
                stocks = _stocks;
            }
        }

        public static void LoadStockDetail(string tickername)
        {
